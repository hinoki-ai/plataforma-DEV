...
import { GET as getNotifications, POST as createNotification, PATCH as markAsRead } from '@/app/api/notifications/route';
...
const mockSendNotificationToUser = sendNotificationToUser as jest.MockedFunction<typeof sendNotificationToUser>;
const mockBroadcastNotification = broadcastNotification as jest.MockedFunction<typeof broadcastNotification>;
