  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      <div className={cn("relative", sizeClasses[size])}>
        ...
        <div className="absolute inset-0 rounded-full bg-linear-to-br from-slate-200 via-slate-300 to-slate-400 dark:from-slate-600 dark:via-slate-700 dark:to-slate-800 animate-pulse"></div>

        {/* Crescent shadow overlay */}
        <div className="absolute inset-0 rounded-full bg-linear-to-br from-transparent via-transparent to-slate-100 dark:to-slate-900 transform rotate-12 animate-pulse"></div>

        {/* Glow effect */}
        <div className="absolute inset-0 rounded-full bg-linear-to-br from-blue-400/20 via-purple-400/20 to-indigo-400/20 dark:from-blue-500/30 dark:via-purple-500/30 dark:to-indigo-500/30 animate-pulse"></div>
...
export function DarkMoonLoader({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center", className)}>
      <div className={cn("relative", sizeClasses[size])}>
        {/* Dark moon base */}
        <div className="absolute inset-0 rounded-full bg-linear-to-br from-slate-800 via-slate-900 to-black animate-pulse"></div>

        {/* Moon surface details */}
        <div className="absolute inset-1 rounded-full bg-linear-to-br from-slate-700 via-slate-800 to-slate-900"></div>

        {/* Crescent highlight */}
        <div className="absolute inset-2 rounded-full bg-linear-to-br from-slate-600 via-slate-700 to-transparent transform -rotate-12"></div>

        {/* Glow effect */}
        <div className="absolute inset-0 rounded-full bg-linear-to-br from-blue-500/20 via-purple-500/20 to-indigo-500/20 animate-pulse"></div>
