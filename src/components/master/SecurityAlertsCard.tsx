...
export function SecurityAlertsCard() {
  ...
  useEffect(() => {
    const mockAlerts: SecurityAlert[] = [
      ...
      },
      {
        ...
        description: 'Large number of SELECT queries on user data from non-standard source',
  ...
  const filteredAlerts = useMemo(() => {
    ...
    if (filter === 'critical') return alerts.filter(alert => alert.level === 'critical');
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <Badge className={cn("text-xs", getLevelColor(alert.level))}>
