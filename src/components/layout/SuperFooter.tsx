          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                ...
                <span className="text-sm">{t("home.footer.contact.address", "common")}</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                ...
                <span className="text-sm">{t("home.footer.contact.phone", "common")}</span>
              </div>
              ...
              <div className="flex items-center gap-3 text-slate-400 hover:text-white transition-colors group">
                ...
                <span className="text-sm">{t("home.footer.contact.email", "common")}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium">{t("home.footer.links.team", "common")}</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium">{t("home.footer.links.portal", "common")}</span>
              </a>
              ...
              >
                ...
                <span className="text-sm font-medium">{t("home.footer.links.mineduc", "common")}</span>
              </a>
            </div>
          </div>
