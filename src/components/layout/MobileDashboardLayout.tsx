...
import { Menu, X, Bell, Home, Users, Calendar, FileText, Settings } from 'lucide-react';
...
export function MobileDashboardLayout({ children, title, subtitle }: MobileDashboardLayoutProps) {
