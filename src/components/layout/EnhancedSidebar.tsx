...
import { Search, Command, HelpCircle, Zap, Star, Crown, Globe, Settings, Eye, AlertTriangle, Monitor, Database, Shield, Terminal, FileText } from 'lucide-react';
...
const getEnhancedNavigation = (t: (key: string, namespace?: string) => string) => ({
  ADMIN: [
    {
...
export function EnhancedSidebar({
  ...
  const navigationItems = useMemo(() => {
    ...
    const items =
      navigation[
        session.user.role as keyof typeof navigation
      ] || [];
  ...
  const keyboardShortcuts = useMemo(() => {
    ...
    const roleShortcuts = session?.user?.role
      ? shortcuts[
          session.user.role as keyof typeof shortcuts
        ] || {}
      : {};
            ...
            {session?.user?.role === 'MASTER' && (
              <div className="space-y-4 border-t border-blue-200 dark:border-blue-800 pt-6">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">System overview</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/system-monitor' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Real-time monitoring</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/database-tools' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Database management</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/global-settings' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">System configuration</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/security' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Threat analysis</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/audit-logs' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Activity tracking</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/audit-master' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Advanced auditing</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/user-analytics' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">User behavior analysis</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/role-management' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Access control</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/performance' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">System performance</span>
                    </div>
                  </Button>

                  <Button
                    variant={pathname === '/master/debug-console' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Advanced debugging</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/global-oversight' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Cross-system control</span>
                    </div>
                  </Button>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Button
                    variant={pathname === '/master/god-mode' ? 'default' : 'ghost'}
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Supreme control</span>
                    </div>
                  </Button>

                    <Button
                      variant={pathname === '/master/advanced-operations' ? 'default' : 'destructive'}
                    className={`w-full justify-start text-red-700 dark:text-red-300 hover:bg-red-50 dark:hover:bg-red-950/20 border ${
                    ...
                    <div className="flex flex-col items-start">
                      ...
                      <span className="text-[10px] opacity-70">Critical operations</span>
                    </div>
                    </Button>
                </div>
              </div>
