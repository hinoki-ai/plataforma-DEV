...
export function ProfileCompletionBadge({ className, compact = false }: ProfileCompletionBadgeProps) {
  ...
  const isProfileComplete = checkProfileCompletion(session.user as ExtendedUser);
