...
import { Calendar, Clock, Users, Plus, Filter, Edit, Eye, Trash2 } from 'lucide-react';
      ...
      <div className="space-y-6">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            {t('profesor.activities.description', 'Gestiona tus actividades educativas')}
          </p>
        </div>
      ...
      <div className="mb-8">
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {t('profesor.activities.filter.all', 'profesor')} ({activities.length})
          </Button>
          <Button
          ...
          >
            {t('profesor.activities.filter.upcoming', 'profesor')} ({upcomingActivities.length})
          </Button>
          <Button
          ...
          >
            {t('profesor.activities.filter.completed', 'profesor')} ({completedActivities.length})
          </Button>
        </div>
      </div>
                ...
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex flex-col gap-2 ml-2">
                    ...
                    <Badge variant={isUpcoming(activity.scheduledDate, activity.scheduledTime) ? "default" : "secondary"}>
                      {isUpcoming(activity.scheduledDate, activity.scheduledTime) ? 'Próxima' : 'Completada'}
                    </Badge>
                  </div>
                </div>
              </CardHeader>
              <CardContent>
                <div className="space-y-2 mb-4">
                  ...
                  <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    {formatTime(activity.scheduledTime)} ({activity.duration} min)
                  </div>
                ...
                <div className="flex gap-2">
                  <Button
                    ...
                    variant="outline"
                    className="flex-1"
                    onClick={() => router.push(`/profesor/actividades/${activity.id}`)}
                  >
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="flex-1"
                    onClick={() => router.push(`/profesor/actividades/${activity.id}/editar`)}
                  >
...
export default function ActividadesPage() {
  return (
    <ErrorBoundary fallback={<div>Error al cargar la página de actividades</div>}>
