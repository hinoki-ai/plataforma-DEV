...
function DisciplinaAdminContent() {
  ...
  const recentCases = [
    {
      student: "Juan Pérez",
      infraction: "Llegada tarde",
      measure: "Amonestación",
      date: "2024-11-15",
      status: "resolved",
    },
    {
      student: "María González",
      infraction: "Falta de material",
    ...
    },
    {
      ...
      infraction: "Comportamiento disruptivo",
      measure: "Citación apoderado",
      date: "2024-11-13",
      status: "pending",
    },
  ];
            ...
            <Card key={index}>
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  ...
                  <Badge
                    variant={
                      protocolo.trend.startsWith("+") ? "secondary" : "outline"
                    }
                  >
                    {protocolo.trend}
                  </Badge>
