      ...
      <div className="space-y-6">
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Curso: {acta.grade} • Entrevistador: {acta.interviewer} •{" "}
                      {acta.date}
                    </p>
                  </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Documentos del listado institucional relacionados con seguimientos
              estudiantiles
            </CardDescription>
          </CardHeader>
          <CardContent>
