...
function MedidasMasterContent() {
  ...
  const measuresEffectiveness = [
    {
      measure: "Amonestación Verbal",
      applications: 456,
      effectiveness: 78,
      trend: "+5%",
    },
    {
      measure: "Trabajo de Reflexión",
      applications: 234,
      effectiveness: 91,
      trend: "+12%",
    },
    {
      measure: "Suspensión de Clases",
      applications: 89,
      effectiveness: 65,
      trend: "-8%",
    },
    {
      measure: "Servicio Comunitario",
      applications: 67,
      effectiveness: 88,
      trend: "+15%",
    },
      ...
      <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold">
                    {globalMeasuresStats.totalApplications.toLocaleString()}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold">
                    {globalMeasuresStats.averageEffectiveness}%
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm font-bold">
                    {globalMeasuresStats.mostUsedMeasure}
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold">
                    {globalMeasuresStats.systemOptimization}%
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Análisis de rendimiento de cada medida correctiva en el sistema
              global
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div className="flex items-center space-x-3">
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                          {measure.applications} aplicaciones
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <p className="text-sm font-medium">
                        {measure.effectiveness}% efectividad
                      </p>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-700 mt-1">
                  Implementar seguimiento post-medida para todas las
                  instituciones mejoraría la efectividad general en un 10-15%.
                </p>
              </div>
            </div>
          </CardContent>
