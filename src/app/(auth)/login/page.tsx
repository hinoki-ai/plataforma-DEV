  ...
  return (
    <div className="flex w-full justify-center px-4 sm:px-6">
      <div className="glass-panel mx-auto flex w-full max-w-md flex-col items-center p-6 text-center text-foreground sm:p-10">
        {/* Google Sign In Button - Positioned at the very top */}
        <div className="w-full mb-6">
          <SignInButton mode="modal">
            <Button
              variant="outline"
              className="w-full rounded-xl border border-border bg-card text-card-foreground shadow-sm transition hover:bg-card/80"
            >
