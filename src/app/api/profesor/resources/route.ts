...
const educationalResources = {
  digitalLibrary: {
    ...
    description: 'Accede a miles de libros, artículos científicos y recursos educativos digitales.',
    items: [
      {
        title: 'Biblioteca Nacional Digital',
        description: 'Recursos educativos gratuitos de la Biblioteca Nacional de Chile',
  ...
  teachingMaterials: {
    ...
    description: 'Herramientas y materiales para el desarrollo de clases interactivas.',
    items: [
      {
        title: 'Khan Academy',
  ...
  pedagogicalTools: {
    ...
    description: 'Herramientas digitales para mejorar el proceso de enseñanza-aprendizaje.',
    items: [
      {
...
export async function GET(request: NextRequest) {
  try {
    ...
    if (category && category in educationalResources) {
      return NextResponse.json({
        success: true,
        data: educationalResources[category as keyof typeof educationalResources]
      });
    }
