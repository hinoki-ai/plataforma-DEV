    ...
    >
      ...
      <div className="flex items-center justify-center p-4 min-h-[calc(100vh-73px)]">
        <div className="max-w-md w-full">
          ...
          <head>
            <title>Error - Manitos Pintadas</title>
            <meta name="description" content="Ha ocurrido un error inesperado" />
            <meta name="robots" content="noindex, nofollow" />
            <meta property="og:title" content="Error - Manitos Pintadas" />
            <meta property="og:description" content="Ha ocurrido un error inesperado" />
