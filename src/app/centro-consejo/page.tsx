  ...
  return (
    ...
    >
      <div className="min-h-screen bg-gradient-to-b from-black/30 via-black/20 to-black/40">
        ...
        <div
          id="educational-project-content"
                  ...
                  <div className="bg-gradient-to-br from-muted/50 to-muted/30 p-8 rounded-xl border border-primary/20 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-lg font-semibold mb-3 text-white">
                        {t(
                          "proyecto_educativo.document_content_title",
                          "common",
                        )}
                      </h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gradient-to-r from-primary/5 to-purple-500/5 p-6 rounded-xl">
                      <p className="text-lg leading-relaxed text-foreground">
                        {t(
                          "proyecto_educativo.philosophy_description",
                          "common",
                        )}
                      </p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 p-4 bg-gradient-to-r from-white/5 to-white/10 rounded-xl">
                        ...
                        <h3 className="font-semibold text-lg text-white">
                          {t(
                            "proyecto_educativo.specific_objectives",
                            "common",
                          )}
                        </h3>
                      </div>
                      ...
                      <div className="space-y-3">
                        {[
                          t(
                            "proyecto_educativo.specific_objective_1",
                            "common",
                          ),
                          t(
                            "proyecto_educativo.specific_objective_2",
                            "common",
                          ),
                          t(
                            "proyecto_educativo.specific_objective_3",
                            "common",
                          ),
                          t(
                            "proyecto_educativo.specific_objective_4",
                            "common",
                          ),
                          t(
                            "proyecto_educativo.specific_objective_5",
                            "common",
                          ),
                        ].map((item, index) => (
                          <div
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      {
                        title: t(
                          "proyecto_educativo.team_parvularia",
                          "common",
                        ),
                        subtitle: t(
