            ...
            <div className="space-y-8 text-foreground">
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Las instituciones educativas que utilizan nuestros
                      servicios y sus representantes legales autorizados.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <div className="space-y-3 text-muted-foreground">
                  <div>
                    <strong>Datos Personales:</strong> Toda información relativa
                    a personas naturales identificadas o identificables.
                  </div>
                  <div>
                    <strong>Tratamiento:</strong> Operaciones realizadas sobre
                    datos personales, incluyendo recolección, almacenamiento,
                    uso, circulación y eliminación.
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    técnicos, organizativos y legales destinados a proteger
                    datos personales contra pérdida, alteración, acceso no
                    autorizado o tratamiento no permitido.
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-muted-foreground leading-relaxed ml-4 space-y-1">
                      ...
                      <li>
                        Datos de salud (solo con consentimiento específico)
                      </li>
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <ul className="list-disc list-inside text-muted-foreground leading-relaxed space-y-2 ml-4">
                  ...
                  <li>
                    Asistir al encargado en la respuesta a solicitudes de
                    derechos ARCO
                  </li>
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <ul className="list-disc list-inside text-muted-foreground leading-relaxed space-y-2 ml-4">
                  ...
                  <li>
                    Notificar cambios que puedan afectar la seguridad de los
                    datos
                  </li>
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  ubicados en Chile. No se realizan transferencias
                  internacionales de datos personales sin el consentimiento
                  expreso del titular y las garantías adecuadas según la
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  contractual entre Plataforma Astral y la institución
                  educativa. Al finalizar el servicio, los datos serán
                  eliminados o devueltos según las instrucciones del encargado,
                  salvo que exista obligación legal de retención.
                </p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  particularmente la Ley 19.628 sobre Protección de Datos
                  Personales. Cualquier controversia será resuelta en los
              ...
              <div className="backdrop-blur-xl bg-card/80 border border-border rounded-2xl p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  escrito y contar con la aprobación de ambas partes. Los
                  cambios significativos serán notificados con al menos 30 días
                  de anticipación.
                </p>
              </div>
