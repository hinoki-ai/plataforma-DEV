...
export const EDUCATIONAL_LEVELS: EducationalLevel[] = [
  ...
  // ISCED 1 - Primary Education
  {
    ...
    grades: ['1° Básico', '2° Básico', '3° Básico', '4° Básico', '5° Básico', '6° Básico'],
    description: 'Educación fundamental: lectura, escritura, matemáticas básicas'
  },
  ...
  // ISCED 2 - Lower Secondary Education
  {
    ...
    description: 'Consolidación de conocimientos básicos y preparación para educación media'
  },
...
export const INSTITUTION_TYPE_INFO = {
  PRESCHOOL: {
    ...
    icon: '🧸',
    levels: EDUCATIONAL_LEVELS.filter(l => l.institutionTypes.includes('PRESCHOOL'))
  },
  BASIC_SCHOOL: {
    name: 'Basic School',
    ...
    icon: '📚',
    levels: EDUCATIONAL_LEVELS.filter(l => l.institutionTypes.includes('BASIC_SCHOOL'))
  },
  HIGH_SCHOOL: {
    name: 'High School',
    ...
    icon: '🎓',
    levels: EDUCATIONAL_LEVELS.filter(l => l.institutionTypes.includes('HIGH_SCHOOL'))
  },
  COLLEGE: {
    ...
    icon: '🏛️',
    levels: EDUCATIONAL_LEVELS.filter(l => l.institutionTypes.includes('COLLEGE'))
  }
} as const;
...
export function getGradesForInstitutionType(type: EducationalInstitutionType): string[] {
...
export function getSubjectsForInstitutionType(type: EducationalInstitutionType): string[] {
  return [...(SUBJECTS_BY_LEVEL[type] || [])];
}

// Check if current system should show certain features based on institution type
export function shouldShowFeature(feature: string, institutionType: EducationalInstitutionType): boolean {
