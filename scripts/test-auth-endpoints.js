...
async function runTests() {
  ...
  if (results.failed === 0) {
    ...
    console.log(
      "   If you're still experiencing auth issues, the problem is likely:",
    );
    console.log(
      "   1. Client-side configuration (check SessionProvider baseUrl)",
    );
    console.log(
      "   2. Environment variables (check NEXTAUTH_URL, NEXTAUTH_SECRET)",
    );
    ...
    console.log(
      "⚠️  Some endpoints failed. This indicates a server configuration issue.",
    );
    console.log("   Check:");
