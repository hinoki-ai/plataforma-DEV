...
async function testAdminLimits() {
  ...
  try {
    ...
    console.log(`✅ Created test admin: ${testAdmin.email} (ID: ${testAdmin.id})`);
    ...
    if (adminCount >= 1) {
      console.log('🚫 Admin creation limit reached - this is expected behavior!');
      console.log('💡 Business opportunity: Additional admin slots can be sold as premium feature');
    }
