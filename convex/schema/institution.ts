  ...
  educationalConfig: v.optional(
    v.object({
      ...
      enabledFeatures: v.optional(
        v.object({
          parent_meetings: v.optional(v.boolean()),
          academic_planning: v.optional(v.boolean()),
          grading_system: v.optional(v.boolean()),
          daycare_features: v.optional(v.boolean()),
          university_features: v.optional(v.boolean()),
          technical_training: v.optional(v.boolean()),
          thesis_management: v.optional(v.boolean()),
          play_based_learning: v.optional(v.boolean()),
          career_guidance: v.optional(v.boolean()),
          research_projects: v.optional(v.boolean()),
          laboratory_access: v.optional(v.boolean()),
          certification_programs: v.optional(v.boolean()),
          postgraduate_programs: v.optional(v.boolean()),
          technical_specialization: v.optional(v.boolean()),
        }),
      ),
    }),
