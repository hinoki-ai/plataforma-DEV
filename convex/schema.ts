...
export default defineSchema({
  ...
  // Normas de Convivencia Escolar - School coexistence rules
  convivenciaNormas: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
    title: v.string(),
    description: v.string(),
    category: v.union(
  ...
  // Casos Disciplinarios - Disciplinary cases
  convivenciaDisciplina: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
    studentId: v.id("students"),
    courseId: v.id("courses"),
  ...
  convivenciaMedidas: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
    title: v.string(),
    description: v.string(),
    category: v.union(
  ...
  // Reconocimientos - Recognitions/Awards
  convivenciaReconocimientos: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
    studentId: v.id("students"),
    courseId: v.id("courses"),
    type: v.string(),
  ...
  // Actas de Apoderados - Parent meeting minutes
  convivenciaActasApoderados: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
  ...
  // Actas de Alumnos - Student meeting minutes
  convivenciaActasAlumnos: defineTable({
    institutionId: v.optional(v.id("institutionInfo")),
    courseId: v.optional(v.id("courses")),
    meetingDate: v.number(),
    meetingNumber: v.number(),
